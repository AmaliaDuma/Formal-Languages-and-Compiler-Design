...
class Parser:
    ...
    def expand(self):
        ...
        """
        print('>>> expand ')
        self.write_in_output_file('expand', False)
    ...
    def advance(self):
        ...
        :return:
        """
        self.write_in_output_file('advance', False)
    ...
    def momentaryInsuccess(self):
        ...
        :return:
        """
        self.write_in_output_file('momentary insuccess', False)
    ...
    def back(self):
        ...
        :return:
        """
        self.write_in_output_file('back', False)
    ...
    def anotherTry(self):
        ...
        :return:
        """
        self.write_in_output_file('another try', False)
        last = self._working_stack.pop()  # step 1
        # step 2
    ...
    def success(self):
        ...
        :return:
        """
        self.write_in_output_file('success', False)
